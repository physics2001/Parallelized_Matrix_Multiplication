...
object CreateRDDWithWeights {

  def main(args:Array[String]): Unit ={

    val spark:SparkSession = SparkSession.builder()
      .master("local[3]")
      .appName("CreateRDDWithWeights")
      .getOrCreate()
    ...
    val R1 = spark.sparkContext.parallelize(Seq((1, 3, 0.798), (1, 2, 0.991), (1, 4, 0.992), (1, 8, 0.987),
      ...
      (2, 7, 0.9090), (2, 1, 0.2), (2, 20, 0.5), (2, 18, 0.433), (2, 6, 0.452), (2, 11, 0.137), (2, 13, 0.157),
      ...
      (3, 2, 0.4), (3, 7, 0.66), (4, 8, 0.833), (7, 8, 0.911), (11, 8, 0.488)))
    R1.foreach(println)
    R1.coalesce(1,true).saveAsTextFile("data/R1SimpleWeighted");
    ...
    R2.foreach(println)
    R2.coalesce(1,true).saveAsTextFile("data/R2SimpleWeighted")
  }
}
